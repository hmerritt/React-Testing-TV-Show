...
//     await wait();
//     fireEvent.click(getByText("Season 1"));
//     await wait();
//
//     findByText(/Chapter One: The Vanishing of Will Byers/i);
//
// });

// test("renders seasons as expected", async () => {
//     const { getByText, findByText, findAllByText } = render(<App />);
//
//     await wait();
//     fireEvent.click(getByText("Select a season"));
//     fireEvent.click(getByText("Season 2"));
//     await wait();
//
//     findByText(/Chapter One: The Vanishing of Will Byers/i);
//     findByText(/Chapter Two: The Weirdo on Maple Street/i);
//     findByText(/Chapter Three: Holly, Jolly/i);
// });
